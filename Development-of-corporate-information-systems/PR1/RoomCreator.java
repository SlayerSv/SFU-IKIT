...
public class RoomCreator {
    ...
    /**
     * Shows a user menu to choose what type of room he wants to create, accepts
     * input and
     * invokes different create methods of rooms based on it. Runs unfinite while
     * loop until
    ...
    public static void chooseAndCreateRoom(ArrayList<Room> roomsList) {
        ...
        do {
            ...
            message = "Enter the number of a room type: ";
    ...
    /**
     * Creates a base room by accepting and validating values from a user. Makes
     * sure that
    ...
    /**
     * Creates a classroom by accepting and validating values from a user. Makes
     * sure that
     * entered values are in certain range.
     * 
    ...
    /**
     * Creates an office room by accepting and validating values from a user. Makes
     * sure that
     * entered values are in certain range.
     * 
    ...
    /**
     * Creates a gym room by accepting and validating values from a user. Makes sure
     * that
     * entered values are in certain range.
     * 
    ...
    public static GymRoom createGymRoom() {
        ...
        System.out.print("New gym room has been created!\n");
        return newGymRoom;
    }
}