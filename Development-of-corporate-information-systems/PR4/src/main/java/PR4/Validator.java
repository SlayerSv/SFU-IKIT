...
public class Validator {
     ...
     * until user enters correct data.
     * 
     ...
     * @return Successfully validated value entered by a user.
     */
    ...
    /**
     * Checks that a user enters a number greater or equal to certain value, runs infinite loop
     * until user enters correct data.
     * 
     * @param minValue Minimal value that can be accepted from a user.
     * @param message  Message that tells a user for what field the data is entered.
     * @return Successfully validated value entered by a user.
     */
    public static int validateNumber(int minValue, String message) {
        while (true) {
            try {
                System.out.print(message);
                input = scanner.nextInt();
