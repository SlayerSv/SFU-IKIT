...
public class GymRoom extends Room {
    ...
    /**
     * Default constructor, used to create a gym room with unknown values, uses
     * super method
    ...
    /**
     * Custom constructor to create a gym room with known values. Calls parent`s
     * constructor
     * of the class Room. Checks values to be in a certain range, if they are not,
     * sets them to
    ...
    /**
     * Sets the number of people that can exercise in this gym room. Checks that
     * values are
