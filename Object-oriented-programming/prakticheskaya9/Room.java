...
/**
 * Parent class of all rooms, contains overrided methods of equals, toString and hash code.
 */
public class Room {
  ...
  /**
   * Custom constructor with parameters, checks that user enters values in certain range.
