...
public class ClassRoom extends Room {
  ...
  /**
   * Default constructor, used to create a classroom with unknown values, uses super method to call
  ...
  /**
   * Custom constructor to create a classroom with known values. Calls parent`s constructor
   * of class Room. Checks values to be in a certain range, if they are not, sets them to
